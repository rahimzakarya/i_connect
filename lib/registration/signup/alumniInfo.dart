...
class AlumnInfoWidget extends StatefulWidget {
  const AlumnInfoWidget({Key key}) : super(key: key);

  @override
  _AlumnInfoWidgetState createState() => _AlumnInfoWidgetState();
}

class _AlumnInfoWidgetState extends State<AlumnInfoWidget> {
